...
namespace GodsCarrom.UI
{
    public class GodSelectionUIController
    {
        ...
        private TextMeshProUGUI abilityTextPrefab;
        ...
        public GodSelectionUIController(GodSelectionUIView godSelectionUIView, GodButtonView godButtonPrefab, TextMeshProUGUI abilityTextPrefab)
        {
            this.godSelectionUIView = godSelectionUIView;
            this.godButtonPrefab = godButtonPrefab;
            this.abilityTextPrefab = abilityTextPrefab;
        ...
        private void CreateGodButtons()
        {
            foreach(GodName godName in Enum.GetValues(typeof(GodName)))
            {
                ...
                newGodButton1.CreateAbilityTexts(godSO.abilities, abilityTextPrefab);
                ...
                newGodButton2.CreateAbilityTexts(godSO.abilities, abilityTextPrefab);
