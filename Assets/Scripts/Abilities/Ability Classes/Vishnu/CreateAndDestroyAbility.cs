...
{
    public class CreateAndDestroyAbility : Ability //maybe make this premove ability
    {
        private AbilitiesEnum abilityName;

        public CreateAndDestroyAbility(PlayerNumber playerNumber, AbilitiesEnum abilityName)
        {
